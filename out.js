(() => {
  ...
  var EXP_LIMIT, MAX_DIGITS, NUMERALS, LN10, PI, DEFAULTS, inexact, quadrant, external, decimalError, invalidArgument, precisionLimitExceeded, cryptoUnavailable, tag, mathfloor, mathpow, isBinary, isHex, isOctal, isDecimal, BASE, LOG_BASE, MAX_SAFE_INTEGER, LN10_PRECISION, PI_PRECISION, P, divide, Decimal2, decimal_default;
  var init_decimal = __esm({
    "node_modules/decimal.js/decimal.mjs"() {
      ...
      Decimal2 = P.constructor = clone(DEFAULTS);
      LN10 = new Decimal2(LN10);
      PI = new Decimal2(PI);
      decimal_default = Decimal2;
    }
  });
  ...
  function test() {
    console.log((0, import_dayjs.default)().format("YYYY-MM-DD HH:mm:ss"));
    Promise.resolve().then(() => (init_decimal(), decimal_exports)).then((decimal) => {
      console.log("decimal.js", decimal);
      const x = new Decimal(255.5);
